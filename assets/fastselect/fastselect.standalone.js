...
(function(root, factory) {
    ...
    $.extend(Fastselect.prototype, {
        ...
        addChoiceItem: function(optionModel) {
            ...
            // $(
            //     '<input name="tags" text="' + optionModel.text + '" value="' + optionModel.value + '" class="' + this.options.choiceItemClass + '" >' +
            //         $('<div>').html(optionModel.text).text() + '<button class="' + this.options.choiceRemoveClass + '" type="button">×</button>' +
            //     '</input>'
            // ).insertBefore(this.$queryInput);

            $(
                '<div name="tags" text="' + optionModel.text + '" value="' + optionModel.value + '" class="' + this.options.choiceItemClass + '" >' +
                     $('<div>').html(optionModel.text).text() + '<button class="' + this.options.choiceRemoveClass + '" type="button">×</button>' +
                 '</div>'
                ).insertBefore(this.$queryInput);
        },
