...
(1,'Executive Summary                                 ','performance/exec_summary',NULL,1,1,NULL,NULL,NULL,NULL,'intranet')
,(2,'Segment Client By Profit                          ','perform/segment',NULL,1,1,NULL,NULL,NULL,NULL,'intranet')
,(3,'Top and Bottom                                    ','performance/topbottom',NULL,1,1,NULL,NULL,NULL,NULL,'intranet')
,(4,'Customer Leaderboard                              ','perform/customerleaderboards',NULL,1,1,NULL,NULL,NULL,NULL,'intranet')
,(5,'RM Leaderboard                                    ','perform/rmleaderboards',NULL,1,1,NULL,NULL,NULL,NULL,'intranet')
...
,(24,'Draft List                                        ','pipeline/draft_pipeline',NULL,7,1,NULL,NULL,NULL,NULL,'intranet')
,(25,'Submitted List                                    ','pipeline/submitted_pipeline',NULL,7,1,NULL,NULL,NULL,NULL,'intranet')
,(26,'History                                           ','pipeline/history_pipeline',NULL,7,1,NULL,NULL,NULL,NULL,'intranet')
;
