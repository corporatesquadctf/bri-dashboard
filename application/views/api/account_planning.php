...
<body>
    <div class="form_actions">
        <a class="btn btn-sm btn-default btn_cancels" type="button" style="width: 200px;" id="btnPrint" href="<?= base_url('api/export/print_account_planning/'.$AccountPlanningId); ?>" target="_blank">Download as PDF</a>
    </div>
    <div class="book">
        <div class="page">
            <div class="subpage">
