                ...
                <div class="x_content">
                    <div style="background: #f5f5f5; padding: 20px; margin-bottom: 20px; height: 250px;">
                        <form id="statusform" method="GET">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="nama" value="<?= $_SESSION['PERSONAL_NUMBER']; ?>">
                    ...
                    <div class="container" style="margin-bottom: 20px;">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="<?= base_url(); ?>profile">All</a></li>
                            <li><a href="<?= base_url(); ?>profile/own">Own</a></li>
                            <?php if ($_SESSION['ROLE_ID'] != 1) : ?>
                                <li><a href="<?= base_url('profile/mentions') ?>">Mentions</a></li>
                            <?php endif; ?>
                        </ul>
                    </div>
