...
<div class="right_col" role="main">    
    <div class="container">
                ...
                <div class="x_panel container_header">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?= base_url().'monitoring/portofolio_kredit'; ?>">Portofolio Kredit</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Detail</li>
                        </ol>
                    </nav>
                    <div class="x_title">
                        <div class="page_title">
                            <div class="pull-left">Detail Portofolio Kredit</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row hyphenate">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        <?php
                            $startDate = date("Y-m-d", strtotime($PortofolioKredit->CreatedDate));
                            $startDateTime = strtotime($startDate);
                            $endDate = $PortofolioKredit->TanggalPutusan;
                            if($endDate == null){
                                $endDate = date("Y-m-d");
                            }else{
                                $endDate = date("Y-m-d", strtotime($PortofolioKredit->TanggalPutusan));
                            }
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-xs-6">
                                        ...
                                        <div class="form-group col-xs-12">
                                            <label style="font-weight: normal;"><?= $portofolio->CustomerName; ?></label>
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-3">
                                        <div class="form-group col-xs-12"><label style="color: #218FD8;">Usulan Plafond :</label></div>
                                        <div class="form-group col-xs-12">
                                            <label style="font-weight:normal;" class="money" data-a-sep="," data-a-dec="."><?= $portofolio->TotalPlafondPermohonan; ?></label>
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-3">
                            ...
                            <div class="col-xs-12 col-lg-4">
                                <?php
                                    if($PortofolioKredit->StatusPutusan == 0){
                                        if($PortofolioKredit->StatusApplicationId == $roleId) :
                                    ...
                                    }else if($PortofolioKredit->StatusPutusan == 1){
                                        if($roleId == 17 && $PortofolioKredit->StatusApplicationId == 17 && $PortofolioKredit->IsAkad == 0):
        ...
        <?php if($PortofolioKredit->IsAkad == 1): ?>
        <div class="row hyphenate">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                            ...
                            <div class="col-xs-12 col-lg-8">
                                <div class="row">
                                    <div class="col-xs-6 col-sm-3">
                                        ...
                                        <div class="form-group col-xs-12">
                                            <label style="font-weight: normal;"><?= date("d F Y", strtotime($PortofolioKredit->TanggalAkad)); ?></label>
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-3">
                                        <div class="form-group col-xs-12"><label style="color: #218FD8;">Nama Notaris:</label></div>
                                        <div class="form-group col-xs-12">
                                            <label style="font-weight: normal;"><?= $PortofolioKredit->NamaNotaris; ?></label>
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6">
                                        <div class="form-group col-xs-12"><label style="color: #218FD8;">Keterangan:</label></div>
                                        <div class="form-group col-xs-12">
                                            <label style="font-weight:normal;"><?= $PortofolioKredit->Keterangan; ?></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="x_panel">
                    <div class="x_title">
                        <div style="display: flow-root;">
                            ...
                            <a href="<?= base_url("export/dokumen_lkn/".$PortofolioKredit->PortofolioKreditId."/1"); ?>" target="_blank" class="btn btn-sm btn-primary pull-right" style="margin-bottom:0px; font-size: 12px;" type="button">Export Dokumen LKN</a>
                        </div>
                    </div>
                    <div class="x_content">
                        <div class="row">
                            <div class="col-xs-6">
                                ...
                                <div class="row">
                                    <div class="col-xs-12" style="padding: 0 20px;"><label style="font-weight: 600; font-size: 14px; color: #000;"><?= $PortofolioKredit->CustomerName; ?></label></div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-12" style="padding: 0 20px;"><label>Alamat</label></div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-12" style="padding: 0 20px;"><label style="font-weight: 600; font-size: 14px; color: #000;"><?= $PortofolioKredit->Address; ?></label></div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-12" style="padding: 0 20px;"><label>Waktu Kunjungan</label></div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-12" style="padding: 0 20px;"><label style="font-weight: 600; font-size: 14px; color: #000;"><?= $WaktuKunjungan = empty($PortofolioKredit->WaktuKunjungan) ? "-": date("Y-m-d h:i:s", strtotime($PortofolioKredit->WaktuKunjungan)); ?></label></div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-12" style="padding: 0 20px;"><label>Hasil Kunjungan</label></div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-12" style="padding: 0 20px;"><label style="font-weight: 600; font-size: 14px; color: #000;"><?= $PortofolioKredit->HasilKunjungan; ?></label></div>
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-xs-12" style="padding: 0 20px;"><label style="font-weight: 600; font-size: 14px; color: #000;"><?= $PortofolioKredit->Tanggapan; ?></label></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xs-6">
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <a href="<?= base_url("export/surat_permohonan/".$PortofolioKredit->PortofolioKreditId."/1"); ?>" target="_blank" class="btn btn-sm btn-primary pull-right" style="margin-bottom:0px; font-size: 12px;" type="button">Export Surat Permohonan</a>
                        </div>
                    </div>
                    <div class="x_content">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-xs-12" style="padding: 0 20px;"><label style="font-weight: 600; font-size: 14px; color: #000;"><?= $PortofolioKredit->JangkaWaktu; ?></label></div>
                        </div>
                        <div class="row">
            ...
            <div class="col-xs-6">
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <a href="<?= base_url("export/kelengkapan_dokumen/".$PortofolioKredit->PortofolioKreditId."/1"); ?>" target="_blank" class="btn btn-sm btn-primary pull-right" style="margin-bottom:0px; font-size: 12px;" type="button">Export Kelengkapan Dokumen</a>
                    </div>
                    <div class="x_content">
                    <?php foreach($PortofolioKreditDocument as $row): 
        ...
        <div class="row">
            <?php 
                ...
                $visitedARK = '';
                $visitedKomite = '';
                if(!empty($historyPortofolioKreditRM)) $visitedRM = "ellipse-visited";
                if(!empty($historyPortofolioKreditADK)) $visitedADK = "ellipse-visited";
                if(!empty($historyPortofolioKreditARK)) $visitedARK = "ellipse-visited";
                if(!empty($historyPortofolioKreditKomite) || !empty($historyProsesKreditKadiv)) $visitedKomite = "ellipse-visited";
                
                $activeRM = '';
                $activeADK = '';
                $activeARK = '';
                $activeKomite = '';
                switch($PortofolioKredit->StatusApplicationId){
                    ...
                    <div class="x_content" style="padding:0px; margin-top:0px;">
                        <div class="dashboard-widget-content" style="padding:0px;">
                            <ul class="list-unstyled widget" style="max-width: none;">
                                <li class="li-card">
                                    <?php
                                        if(!empty($historyPortofolioKreditKomite)){
                                            $komiteDesc = $historyPortofolioKreditKomite[0]->CreatedByName;
                                            if($historyPortofolioKreditKomite[0]->IsApproved == 1){
                                                $komiteDesc .= ' Mengirim Paket ke ';
                                            }else $komiteDesc .= ' Mengembalikan Paket ke ';
                                            $komiteDesc .= $historyPortofolioKreditKomite[0]->ROLE_NAME;
                                            $komiteLastDescription = $komiteDesc;
                                            $komiteLastDate = date("d F Y H:i:s", strtotime($historyPortofolioKreditKomite[0]->CreatedDate));
                                            $komiteLastComment = $historyPortofolioKreditKomite[0]->Comment;
                                        }else{
                                    ...
                                    <div class="li-block" style="padding: 0px;">
                                        <div class="block-content">
                                            <div class="row detail_div" id="rowDetailKomite">
                                                ...
                                                <?php
                                                    $iKomite = 0;
                                                    if(count($historyPortofolioKreditKomite) < 2){
                                                    ...
                                                    foreach($historyPortofolioKreditKomite as $row) {
                                                        $iKomite++;
                                ...
                                <li class="li-card">
                                    <?php
                                        if(!empty($historyPortofolioKreditARK)){
                                            $ARKDesc = $historyPortofolioKreditARK[0]->CreatedByName;
                                            if($historyPortofolioKreditARK[0]->IsApproved == 1){
                                                $ARKDesc .= ' Mengirim Paket ke ';
                                            }else $ARKDesc .= 'Mengembalikan Paket ke ';
                                            $ARKDesc .= $historyPortofolioKreditARK[0]->ROLE_NAME;
                                            $ARKLastDescription = $ARKDesc;
                                            $ARKLastDate = date("d F Y H:i:s", strtotime($historyPortofolioKreditARK[0]->CreatedDate));
                                            $ARKLastComment = $historyPortofolioKreditARK[0]->Comment;
                                        }else{
                                            $ARKLastDescription = '-';
                                            $ARKLastDate = '-';
                                            $ARKLastComment = '-';
                                    ...
                                    <div class="li-block" style="padding: 0px;">
                                        <div class="block-content">
                                            <div class="row detail_div" id="rowDetailARK">
                                                ...
                                                <?php
                                                    $iARK = 0;
                                                    if(count($historyPortofolioKreditARK) < 2){
                                                        echo '<div class="row" style="margin:0 5px;">';
                                                        echo    '<div class="col-xs-12" style="text-align:center; margin-bottom:5px;">';
                                                        echo    'Tidak Ada Data Detail';
                                                        echo    '</div>';
                                                    ...
                                                    foreach($historyPortofolioKreditARK as $row) {
                                                        $iARK++;
                                                        if($iARK == 1) continue;
                                ...
                                <li class="li-card">
                                    <?php
                                        if(!empty($historyPortofolioKreditADK)){
                                            $ADKDesc = $historyPortofolioKreditADK[0]->CreatedByName;
                                            if($historyPortofolioKreditADK[0]->IsApproved == 1){
                                                $ADKDesc .= ' Mengirim Paket ke ';
                                            }else $ADKDesc .= ' Mengembalikan Paket ke ';
                                            $ADKDesc .= $historyPortofolioKreditADK[0]->ROLE_NAME;
                                            $ADKLastDescription = $ADKDesc;
                                            $ADKLastDate = date("d F Y H:i:s", strtotime($historyPortofolioKreditADK[0]->CreatedDate));
                                            $ADKLastComment = $historyPortofolioKreditADK[0]->Comment;
                                        }else{
                                            $ADKLastDescription = '-';
                                            $ADKLastDate = '-';
                                            $ADKLastComment = '-';
                                        ...
                                        <div class="block-content">
                                            <div class="row detail_div" id="rowDetailADK">
                                                <div class="col-xs-12">
                                                    <?php
                                                        $iADK = 0;
                                                        if(count($historyPortofolioKreditADK) < 2){
                                                            echo '<div class="row" style="margin:0 5px;">';
                                                            echo    '<div class="col-xs-12" style="text-align:center; margin-bottom:5px;">';
                                                            echo    'Tidak Ada Data Detail';
                                                            echo    '</div>';
                                                        ...
                                                        foreach($historyPortofolioKreditADK as $row) {
                                                            $iADK++;
                                                            if($iADK == 1) continue;
                                ...
                                <li class="li-card">
                                    <?php
                                        if(!empty($historyPortofolioKreditRM)){
                                            $RMDesc = $historyPortofolioKreditRM[0]->CreatedByName;
                                            if($historyPortofolioKreditRM[0]->IsApproved == 1){
                                                $RMDesc .= ' Mengirim Paket ke ';
                                            }else $RMDesc .= 'Mengembalikan Paket ke ';
                                            $RMDesc .= $historyPortofolioKreditRM[0]->ROLE_NAME;
                                            $RMLastDescription = $RMDesc;
                                            $RMLastDate = date("d F Y H:i:s", strtotime($historyPortofolioKreditRM[0]->CreatedDate));
                                            $RMLastComment = $historyPortofolioKreditRM[0]->Comment;
                                        }else{
                                            $RMLastDescription = '-';
                                            $RMLastDate = '-';
                                            $RMLastComment = '-';
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <div class="form-group col-xs-12">
                                                        ...
                                                        <label style="font-weight: normal;  font-weight: bold; font-size:20px;  color:#218FD8;"><?= $PortofolioKredit->RMName; ?></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                        ...
                                        <div class="block-content">
                                            <div class="row detail_div" id="rowDetailRM">
                                                <div class="col-xs-12">
                                                    <?php
                                                        $iRM = 0;
                                                        if(count($historyPortofolioKreditRM) < 2){
                                                            echo '<div class="row" style="margin:0 5px;">';
                                                            echo    '<div class="col-xs-12" style="text-align:center; margin-bottom:5px;">';
                                                            echo    'Tidak Ada Data Detail';
                                                            echo    '</div>';
                                                        ...
                                                        foreach($historyPortofolioKreditRM as $row) {
                                                            $iRM++;
                                                            if($iRM == 1) continue;
        ...
        <div class="modal fade modal-teruskan-portofolio-kredit" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content" >
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel">Komentar</h4>
                    </div>
                    <div class="modal-body teruskan_body yscroller" style="height: 250px; overflow-y: auto;">
                        <form id="formTeruskanPortofolioKredit" action="<?= base_url().'monitoring/portofolio_kredit/teruskan_proses_kredit'; ?>" method="POST">
                            <div class="row form-group">
                                <div class="col-xs-12">
                                    <input type="hidden" id="portofolioKreditId" name="portofolioKreditId" value="<?= $PortofolioKredit->PortofolioKreditId; ?>"> 
                                    <?php
                                    ...
                                    <?php 
                                        if($roleId == USER_ROLE_RM_MENENGAH): 
                                            $waktuKunjungan = $PortofolioKredit->WaktuKunjungan != null ? date("Y-m-d h:i:s", strtotime($PortofolioKredit->WaktuKunjungan)) : "";
                                            $hasilKunjungan = $PortofolioKredit->HasilKunjungan != null ? $PortofolioKredit->HasilKunjungan : "";                                    
                                    ?>
                                    <p style="font-weight: bold; color: #000;">Nama Debitur:</p>
                                    <p><input type="text" class="form-control" value="<?= $PortofolioKredit->CustomerName; ?>" readonly /></p>
                                    <p style="font-weight: bold; color: #000;">Alamat:</p>
                                    <p><textarea class="form-control" rows="3" readonly><?= $PortofolioKredit->Address; ?></textarea></p>
                                    ...
                                    <div class="row form-group">
                                        <div class="col-xs-4">
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" id="document_portofolio_kredit_<?= $row->ProsesKreditDocumentId; ?>" name="document_portofolio_kredit_<?= $row->ProsesKreditDocumentId; ?>" class="flat" <?= $checked; ?> >
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="btn_confirm_teruskan_portofolio_kredit" type="button" class="btn w150 btn-primary modal-button-ok">Simpan</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formBatalkanProsesKredit" action="<?= base_url().'monitoring/portofolio_kredit/kembalikan_proses_kredit'; ?>" method="POST">
                        <div class="row form-group">
                            <div class="col-xs-12">
                                <input type="hidden" id="kembalikan_portofolioKreditId" name="kembalikan_portofolioKreditId" value="<?= $PortofolioKredit->PortofolioKreditId; ?>">     
                                ...
                                <p style="font-weight: bold; color: #000;">Komentar:</p>
                                <p><textarea maxlength="100" id="kembalikan_comment" name="kembalikan_comment" class="form-control" rows="3" placeholder="Max 100 Character"></textarea></p>
                            </div>
                        </div>
                        </form>
                    </div>
        ...
        <div class="modal fade modal-akad-kredit" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formAkadKredit" class="form-horizontal" action="<?= base_url().'monitoring/portofolio_kredit/akad_kredit'; ?>" method="POST">
                            <div class="row form-group">
                                <div class="col-xs-12">
                                    <input type="hidden" id="akad_portofolioKreditId" name="akad_portofolioKreditId" value="<?= $PortofolioKredit->PortofolioKreditId; ?>"> 
        ...
        <div class="modal fade modal-tanggapan-lkn" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="formTanggapanLKN" class="form-horizontal" action="<?= base_url().'monitoring/portofolio_kredit/edit_tanggapan_lkn'; ?>" method="POST">
                            <div class="row form-group">
                                <div class="col-xs-12">
                                    <input type="hidden" id="tanggapan_portofolioKreditId" name="tanggapan_portofolioKreditId" value="<?= $PortofolioKredit->PortofolioKreditId; ?>"> 
...
<script>
    ...
    var showARK = 0;
    var showKomite = 0;
    var tanggalPutusan = new Date("<?= date("m/d/Y", strtotime($PortofolioKredit->TanggalPutusan)); ?>");
    ...
    $(document).ready(function() {
        ...
        $("#formTeruskanPortofolioKredit").validate({
            ignore: [],
        });
        
        $("#btn_teruskan_proses_kredit").click(function(e){
            $("#formTeruskanPortofolioKredit")[0].reset();
            $("#tujuanDiteruskanId").val(<?= $tujuanDiteruskanOption[0]->ID; ?>).select2().trigger('change');            
            $(".modal-teruskan-portofolio-kredit").modal("show");
                 
        });

        $(".modal-teruskan-portofolio-kredit").on("hidden.bs.modal", function (e) {
            <?php
                foreach($PortofolioKreditDocument as $row):
                    $checked = "uncheck";
                    if ($row->Status == 1) $checked = "check"; 
            ?>
                $("#document_portofolio_kredit_<?= $row->ProsesKreditDocumentId; ?>").iCheck("<?= $checked; ?>"); 
            <?php
                endforeach;
            ?>
        })
        ...
        $("#tujuanDiteruskanId").change(function(){
            ...
            if(role == <?= USER_ROLE_ADK; ?> && tujuan == 14){
                $(".teruskan_body").css("height","500px");
                <?php
                foreach($PortofolioKreditDocument as $row):
                    $checked = "uncheck";
                    if ($row->Status == 1) $checked = "check"; 
                ...
                $(".teruskan_body").css("height","250px");
                <?php
                foreach($PortofolioKreditDocument as $row):
                    $checked = "uncheck";
                    if ($row->Status == 1) $checked = "check"; 
        ...
        $("#btn_confirm_teruskan_portofolio_kredit").click(function(e){
            if($("#formTeruskanPortofolioKredit").valid()){
                e.preventDefault();
                $.ajax({
                    type: "post",
                    url : $("#formTeruskanPortofolioKredit").attr("action"),
                    data: $("#formTeruskanPortofolioKredit").serialize(),
                    dataType : "json",
                    beforeSend:function(){
                        $(".modal-teruskan-portofolio-kredit").modal("hide");
                        $(".loaderImage").show();
                    },
                    success: function(response){
                        $(".loaderImage").hide();
