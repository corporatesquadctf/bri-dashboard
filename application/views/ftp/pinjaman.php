                ...
                <div class="x_panel" style="padding:0 0 10px 0;">
                    <div class="x_content" style="padding: 0">
                        <div style="box-shadow: 0px 3px 5px rgba(149, 149, 149, 0.15);">
                            <form class="form-horizontal" id="formEditFTPPosition" method="POST" action="<?= site_url("ftp/ftp_position/process_edit_pinjaman"); ?>" style="padding: 20px;">
                                    ...
                                    <div class="row" style="margin-bottom: 10px;">
                                        <div class="col-xs-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="desc" name="desc" class="form-control" value="<?php $desc = empty($FTPDetail) ? "Korporasi" : $FTPDetail[0]->Description; echo $desc; ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-xs-4">
                                            <div class="form-group">
