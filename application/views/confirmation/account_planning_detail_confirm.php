            ...
            <div class="x_panel container_header">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item" aria-current="page"><a href="<?=base_url('confirmation/'.$confirmation_user);?>"><?=$confirmation_user?></a></li>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    <?php 
      if ($AccountPlanningTab=='company_information' || $AccountPlanningTab=='bri_starting_position' || $AccountPlanningTab=='client_needs' || $AccountPlanningTab=='action_plans' || $AccountPlanningTab=='simulation') {
        $reff = '';
        if ($AccountPlanningTab=='simulation') {
          $reff = '/'.$confirmation_user;
        } 
      ?>
      $('.loaderImage').show();    
    
      $('#<?=$AccountPlanningTab?>').load("<?= base_url('tasklist/AccountPlanning/view_'.$AccountPlanningTab.'/'.$AccountPlanningId.'/'.$AccountPlanningTabType.$reff)?>", function(responseTxt, statusTxt, xhr){
    ...
    <?php } else {
        redirect(base_url('confirmation/'.$confirmation_user));
    } ?>
    ...
    $("#simulation-tab").click(function(){
      ...
      $(tab_target).load("<?= base_url('tasklist/AccountPlanning/view_simulation/')?>" + AccountPlanningId + "/" + tab_panel_type + "/<?=$confirmation_user?>" , function(responseTxt, statusTxt, xhr){
        if(statusTxt == "success") {
          $('.loaderImage').hide();
        }
