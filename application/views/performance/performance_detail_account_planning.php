            ...
            <div class="x_panel container_header">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item" aria-current="page"><a href="<?=base_url('performance/AccountPlanning');?>">Account Planning</a></li>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
      ...
      $('#<?=$AccountPlanningTab?>').load("<?= base_url('tasklist/AccountPlanning/view_'.$AccountPlanningTab.'/'.$AccountPlanningId.'/'.$AccountPlanningTabType)?>", function(responseTxt, statusTxt, xhr){
