            ...
            <form id="group-overview-form">
                ...
                <div class="form-group">
                    ...
                    <select 
                        ...
                        <?= $mode == 'view' ? 'disabled' : '' ?>
                        >   
                            <?php foreach ($GROUP as $gr1) : ?>
                            <option 
                                value="<?= $gr1['CITY_ID']; ?>" 
                                selected><?= $gr1['Description']; ?></option>
                            <?php endforeach; ?>

                        <?php foreach ($cities as $city) : ?>

                            <option 
                                data-tokens="<?php echo $city['CITY_NAME']; ?>" 
                                value="<?= $city['CITY_ID']; ?>"
                                <?= $mode == 'view' ? 'disabled' : '' ?>
                                >
                                    <?= $city['CITY_NAME']; ?>
                ...
                <div class="form-group">
                    <div class="form-inline">
                        ...
                        <select 
                            ...
                            <?php foreach ($globalrate as $glr) : ?>
                                <!-- <option disabled selected>Choose Database Type</option> -->
                                <option 
                                    id="<?= $glr['GLOBALRATE_DESC']; ?>" 
                                    value="<?= $glr['GLOBALRATE_ID']; ?>" 
                                    <?= $mode == 'view' ? 'disabled' : '' ?>
                                    >
                                        <?= $glr['GLOBALRATE_NAME']; ?>
                                </option>
                ...
                <!-- <div class="form-group">
                    <div class="form-inline">
                        <label for="globalRate">Global Rating 2</label>
                        <br />
                        <select 
                            class="form-control"
                            id="globalrating_id"                                
                <?= $mode == 'view' ? 'disabled' : '' ?>>
                <?php foreach ($globalrate as $glr) : ?>
                                        <option value="<?= $glr['GLOBALRATE_ID']; ?>" >
                    <?= $glr['GLOBALRATE_NAME']; ?>
                                        </option>
                <?php endforeach; ?>
                        </select>
                ...
                <?php if ($mode == 'edit'): ?>
                    <div class="form-group">
                        <div class="col-md-12" align="center">
                            <button type="button" class="btn btn-sm btn-primary" onclick="saveGroupOverview()"> 
                                <span class="glyphicon glyphicon-floppy-disk"></span> Save Data</button>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12" align="center">
                            <p id="group-overview-message" ></p>
                        </div>
                    </div>
        ...
        <div class="x_content">
            <div class="tab">
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#strategic-plan-1"><b>1-3 Year Strategic Plan:</b></a></li>
                    <li><a data-toggle="tab" href="#strategic-plan-2"> <b> > 3 Year Strategic Plan: </b> </a></li>
                </ul>

                <div class="tab-content">
                    <div id="strategic-plan-1" class="tab-pane fade in active">
                        <div class="table-strategic_plan" class="table-editable table-account-planning">
                        ...
                        <?php if ($mode == 'edit'): ?>
                            <div class="row">
                                <div class="col-md-12" align="center" id="strategic-plan-message-1">
                                </div>
                            </div>    
                            <div class = "row">
                                <div class = "btn-annual">
                                    <button class = "btn btn-primary btn-sm" onclick="saveStrategicPlans(1)">
                                        <span class = "glyphicon glyphicon-floppy-disk"></span> Save Data
                                    </button>
                                    <button class = "btn btn-warning btn-sm table-sh-add" onclick="addStrategicPlans(1)">
                                        <span class = "glyphicon glyphicon-plus"></span> Row
                                    </button>
                                </div>
                            </div>
                    ...
                    <div id = "strategic-plan-2" class = "tab-pane fade">
                        ...
                        <?php if ($mode == 'edit') : ?>
                            <div class = "row">
                                <div class = "btn-annual">
                                    <button class = "btn btn-primary btn-sm" onclick="saveStrategicPlans(2)">
                                        <span class = "glyphicon glyphicon-floppy-disk"></span> Save Data
                                    </button>
                                    <button class = "btn btn-warning btn-sm table-sh-add" onclick="addStrategicPlans(2)">
                                        <span class = "glyphicon glyphicon-plus"></span> Row
                                    </button>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12" align="center" id="strategic-plan-message-2">
                                </div>
                            </div>
                        <?php endif; ?>
                    </div>
                    <table class="hide">
                        <tr class="strategic-plan-row">
                            <td class="td-disabled index"><span class='fa fa-chevron-right'></span></td>
                            <?php if ($mode == 'edit'): ?>
                                <td contenteditable="true" class="txt planning"></td>
                                <td>
                    ...
                    <div class="form-group">
                        ...
                        <?php if ($mode == 'edit') : ?>
                            ...
                            <div class="col-sm-12 nopadding">
                                <!-- <input type="submit" name="submit" value="Save Data" class="btn btn-sm btn-primary pull-right "> -->
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                <div class="col-md-6">
                    <div class="form-group">
                        <div>
                            <h4><b>Group Structure</b></h4>
                            <!-- <?php if (empty($gambar)) : ?>
                                        <tr><td colspan='5'>Data tidak ada</td></tr>
                            <?php else : ?>
                                <?php foreach ($gambar as $data) : ?>
                                                    <a href="<?= base_url("uploads/" . $data->PATH) ?>">
                                                        <img src="<?= base_url("uploads/" . $data->PATH) ?>" class="img-responsive thumbnail">
                                                    </a>
                                <?php endforeach; ?>
                            <?php endif; ?> -->
                            <?php foreach ($gambar as $data) : ?>
                        ...
                        <?php if ($mode == 'edit') : ?>
                            ...
                            <small>Format file must be PDF,<br> Maximum Filesize 5MB</small>
                            <div class="col-sm-12 nopadding ">
                                <!-- <input type="submit" name="submit" value="&#xff0c7; Save Data" class="btn btn-sm btn-primary pull-right"> -->
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <h4><b>Company Structure</b></h4>
                        <div>
                            <?php foreach ($gambarStruktur as $data) : ?>
                                <a href="<?= base_url("uploads/" . $data->PATH) ?>">
                                    <i class="fa fa-file-pdf-o" style="font-size:48px;color:red"></i>
                                    <?php echo "$data->PATH"; ?>
                                </a>
                        ...
                        <?php if ($mode == 'edit') : ?>
                            ...
                            <?= form_open("perform/companyinformations/tambah", array('enctype' => 'multipart/form-data')); ?>
                            <input type="hidden" name="TITLE" value="STRUKTUR">
                            <input type="hidden" name="YEAR" value="<?= $account_planning['doc_year']; ?>">
                            <input type="hidden" name="VCIF" value="<?= $account_planning['vcif']; ?>">
...
<!-- MODAL -->
<div id="edit_structure" class="modal fade" role="dialog">
