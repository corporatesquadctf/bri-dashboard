...
<div class="action-plan-template hide"> 
    <br/>
    <b class="action-plan-name"></b>
    <div class="table-editable table-account-planning" style="overflow-x:auto;">
        ...
        <?php if ($mode == 'edit') : ?>
            ...
            <span class="action-plan-message"></span>
        <?php endif; ?>
    </div>
</div>
...
<table class="table-template hide">
    <tr class="action-plan-details-template" align="center">
        ...
        <?php if ($mode == 'edit') : ?>
            <td class="txt td-number numberOnly projection-idr" contenteditable="true" style="text-align: right;"></td>
            <td class="txt td-number numberOnly projection-valas" contenteditable="true" style="text-align: right;"></td>
            <td class="txt td-number numberOnly target-idr" contenteditable="true" style="text-align: right;"></td>
            <td class="txt td-number numberOnly target-valas" contenteditable="true" style="text-align: right;"></td>
        <?php endif; ?>
