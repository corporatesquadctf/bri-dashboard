...
$enabled_txt = 'class="txt" contenteditable="true" style="text-align: right;"';
$enabled_cell = 'class="txt td-number numberOnly" contenteditable="true" style="text-align: right;"';
$enabled_cell_minus = 'class="txt td-number numberMinus" contenteditable="true" style="text-align: right;"';
$enabled_cell_percent = 'class="txt td-number numberPercent bigger100" contenteditable="true" style="text-align: right;"';
?>
...
<?php foreach ($banking_facilities as $banking_facility_id => $banking_facility): ?>
    ...
    <div id="banking-facility-group-<?= $banking_facility_id ?>" class="table-editable table-account-planning" style="overflow-x:auto;">
        <table class="table">
            <thead>
            ...
            <tbody>
                <?php foreach ($banking_facility['details'] as $banking_facility_detail_id => $banking_facility_detail) : ?>
                    ...
                    <tr 
                        ...
                        <?php
                        if ($editable && $banking_facility_detail['optional']) {
                            echo $enabled_txt;
                        } else {
                            echo $disabled_cell;
                        }
                        ...
                        <td style="text-align: right;"
                            <?= $editable ? $enabled_cell_percent : $disabled_cell ?>>
                ...
                <?php if ($mode == 'edit') : ?>
                    <tr data-mandatory="false" class="hide" align="center">
                        ...
                        if ($editable) {
                            ...
                            echo $enabled_cell_minus;
                        } else {
                            
                        } echo $disabled_cell;
                        ?>>0</td>
                        <td <?= $enabled_cell_percent ?>>0</td>
                        <td <?php
                        if ($editable) {
                            echo $enabled_cell;
                        } elseif ($direct_loan) {
