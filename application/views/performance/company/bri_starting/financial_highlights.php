...
<div class="col-md-12">
    <div class="switch-field" id="statusMata" style="float: right; margin-bottom: 20px; position: relative;">
        <b>Select Currency</b>
        <br>
        <input <?= $mode == 'view' ? 'disabled' : '' ?> type="radio" id="rupiah" name="RpDollar" value="1"/>
        <label class="switch-lbl" for="rupiah">Rupiah</label>
        <input <?= $mode == 'view' ? 'disabled' : '' ?> type="radio" id="dollar" name="RpDollar" value="0" />
        <label class="switch-lbl" for="dollar">Dollar</label>
    </div>
</div>
...
<script>
    ...
    var renderFinancialHighlight = function (financialHighlightGroups, financialHighlightGroupId, financialHighlightDisable, financialHighlightCurrency) {
        ...
        var valuez = financialCurrencyId === 0 ? 1 : 0;
        $('input:radio[name=RpDollar]')[valuez].checked = true;
        //
