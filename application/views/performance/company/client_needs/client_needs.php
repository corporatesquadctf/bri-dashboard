...
<div class="col-md-12 col-sm-12 col-xs-12">
    <?php $this->load->view('performance/company/client_needs/funding.php'); ?>
</div>

<div class="col-md-12 col-sm-12 col-xs-12">
    <?php $this->load->view('performance/company/client_needs/services.php'); ?>
</div>
...
<script>
    ...
    //             // tag yg telah disimpan di master table
    //             whitelist: ["IT support", "Mmarketing", "sales"], maxTags: 5
    //         });

    // // remove all tags (event)
    // //document.querySelector('.tags--removeAllBtn').addEventListener('click', tagify1.removeAllTags.bind(tagify1))
