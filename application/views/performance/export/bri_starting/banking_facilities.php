...
$indexing_page = 1;
?>
<b><h4>Facilities with banking</b></h4>
...
<?php foreach ($banking_facilities as $banking_facility_id => $banking_facility): ?>
    ...
    <div id="banking-facility-group-<?= $banking_facility_id ?>" class="x_panel ">
        <div><?= $banking_facility['name'] ?></div>
        <p id="banking-facility-message-<?= $banking_facility_id ?>"></p>
        <table id="banking-facility-table-<?= $banking_facility_id ?>" class="table-template table-bordered" style="width: 100%">
            <thead>
            ...
            <tbody>
                <?php foreach ($banking_facility['details'] as $banking_facility_detail_id => $banking_facility_detail) : ?>
                    ...
                    <tr 
                        ...
                        <td style="text-align: left;"><?= $banking_facility_detail['detail_name'] ?></td>
                        <td style="text-align: right;"><?= ($banking_facility_detail['amount_idr']) ?></td>
                        <td style="text-align: right;"><?= number_format((float) $banking_facility_detail['amount_idr_percent'], 2, '.', '') ?></td>
                        <td style="text-align: right;"><?= ($banking_facility_detail['amount_valas']) ?></td>
                        <td style="text-align: right;"><?= number_format((float) $banking_facility_detail['amount_valas_percent'], 2, '.', '') ?></td>
                        <!-- <?php if ($mode == 'edit'): ?>
                                <td>
