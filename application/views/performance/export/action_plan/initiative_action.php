...
<div id="table-initiative_action" class="x_panel table-editable table-account-planning">
    <h2>Action Plan</h2>
    <table class="table-template table-bordered" style="width: 100%;">
        <thead>
                ...
                <tr class="">
                    ...
                    <td 
                        ...
                        <div class="form-group">
                            <?php
                            $myDateTime = DateTime::createFromFormat('Y-m-d', $initiative_action['period_date']);
                            $formattedinit = $myDateTime->format('m-Y');
                            ?>
                            <?= $formattedinit; ?>
                        </div>
                    </td>
