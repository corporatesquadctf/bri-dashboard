    ...
    <div class="x_panel" style="background: #f7f7f7">
        ...
        <div class="x_content">
            <form id="group-overview-form">
                <div>
                    <label for="companyName">Customer Name: <?= $account_planning['customer_name']; ?></label>
                    <input 
                        type="text" 
                        id="customer_name" 
                        class="form-control" 
                ...
                <div class="form-group">
                    <label>City : <?php
                        empty($GROUP) ? "-" : $GROUP[0]['Description'];
                        ?>
                    </label>
                ...
                <div class="form-group">
                    <label for="domesticRate">Domestic Rating : No Rating</label>
                    <select 
                        width="60%" 
                        class="form-control" 
                ...
                <div class="form-group">
                    <label>Industry Trend : Up-Turn</label>
                    <select 
                        class="form-control" 
                        id="industrytype_id" 
                        <?= $mode == 'view' ? 'disabled' : '' ?>
                ...
                <div class="form-group">
                    <label for="lifeCycle">Life-cycle : Introduction</label>
                    <select 
                        class="form-control" 
                        id="lifecycle_id" 
                        <?= $mode == 'view' ? 'disabled' : '' ?>
