            ...
            <div class="x_panel container_header">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active" aria-current="page"><a href="<?=base_url('performance/AccountPlanning');?>">Account Planning</a></li>
                  </ol>
                </nav>
                <div class="x_title">
          ...
          <div class="x_panel">
            <div>
              ...
              <div class="x_content" <?= ($search_box) ? $search_box : 'style="display: none;"' ?>>
                  <form action="<?=base_url();?>performance/AccountPlanning/search" method="post" class="form-horizontal form-label-left" style="background-color: #f4f4f4; padding: 12px 12px 12px 12px; border: 1px solid #d0d0d0">
                      ...
                      <div class="collapse col-md-12 col-sm-12 col-xs-12" id="collapseExample<?= html_escape($ap_row['AccountPlanningId']); ?>" style="background: #E5F0FF; padding: 10px;">
                        <div class="card card-body">
                          ...
                          <div class="col-md-3 col-sm-3 col-xs-12 padding_con">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                            <form>                              
                              <!-- <button type="button" class="btn" style="font-size: 10px; line-height: 136.89%; letter-spacing: 0.15px; background:transparent; border: 1px solid #F58C38; box-sizing: border-box; border-radius: 2px; color: #F58C38; width: 210px; height: 45px;">CUSTOMER PROFITABILITY ACCOUNT</button> -->
                              <a class="btn" style="font-size: 10px; line-height: 136.89%; letter-spacing: 0.15px; background: #F58C38; border-radius: 2px; color: #fff; width: 210px; height: 45px; padding-top: 14px;" href="<?= base_url("export/preview_account_planning/".$ap_row['AccountPlanningId']); ?>" target="_blank" >EXPORT ACCOUNT PLANNING</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body" style="text-align: center;">
        <p id="confirmation_text1">Your'e about to Clone all Account Planning from year : <?= $tahun_search_box2; ?>.<br>Are you sure?</p>
      </div>
...
<script type="text/javascript">
  ...
  function massCloneAccountPlannings() {
    ...
    var Year = $('#tahun_search_box2').val();
    console.log(Year);
      $.ajax({
          type: "GET",
          ...
          success:function(response) {
            ...
            setTimeout(function(){ 
              $('.loaderImage').hide();
              // window.location.href= base_url+'performance/AccountPlanning';
            }, 2000);
          },
