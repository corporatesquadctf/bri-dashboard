...
<html>
<head>
	<title>BRI Dashboard | Account Planning</title>
</head>
<style type="text/css">
	@page {
		margin: 0px;
...
<footer>
	<table style="width:100%; border-top:1px solid #000;">
		<tr>
			<td style="text-align: left; padding-top: 5px; font-size: 6pt;">
				&copy; HakCipta PT. BANK RAKYAT INDONESIA, Indonesia <br/>
				Account Planning <?= html_escape($account_planning['Year'])." - ".strtoupper(html_escape($account_planning['CustomerName'])); ?><br/>
				<?= $account_planning["Status"]; ?><br/>
				<?= $ExportDate; ?>
			</td>
		</tr>
	</table>	
...
<body>
	<script type="text/php">
        if ( isset($pdf) ) {
            ...
            $font = $fontMetrics->get_font(Rockwell, "normal");
            $size = 10;
            $color = array(0,0,0);
	...
	<table class="account-planning-overview border" style="table-layout: fixed; page-break-inside: auto; border-bottom: 1px solid #000;">
		<tr style="">
			...
			<td class="border hyphenate" style="width: 70%; padding: 10px; vertical-align: middle;">
				<label class="title"><?= strtoupper(html_escape($account_planning['CustomerName'])); ?></label><br/>
					...
					<div class="key-shareholder-content">
						<div class="wrapper">
							<div style="display: table-cell; width: 25%; padding: 2px;">
								<img width="100%" src="<?= base_url("uploads/account_planning/".$AccountPlanningId."/keyshareholders.png"); ?>" />
							</div>
				...
				<div class="financial-group-container">
					...
					<?php
						if ($value[0]['FinancialHighlightGroupId'] == 1 || $value[0]['FinancialHighlightGroupId'] == 2 || $value[0]['FinancialHighlightGroupId'] == 3 || $value[0]['FinancialHighlightGroupId'] == 5 || $value[0]['FinancialHighlightGroupId'] == 6) { 
							switch($value[0]['FinancialHighlightGroupId']){
								case 1: $imgName = "BalanceSheet.png"; break;
								case 2: $imgName = "IncomeStatement.png"; break;
								case 3: $imgName = "Liquidity.png"; break;
								case 5: $imgName = "Profitability.png"; break;
								case 6: $imgName = "Solvability.png"; break;
								default: break;
							}
					?>
							<div class="financial-group-image">
								<img src="<?= base_url("uploads/account_planning/".$AccountPlanningId."/".$imgName); ?>" style="width:100%;" />
							</div>
