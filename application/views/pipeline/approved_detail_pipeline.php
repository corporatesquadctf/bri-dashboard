                ...
                <div class="x_panel container_header">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?= base_url().'pipeline/approved'; ?>">Approved</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12">
                                        ...
                                        <div class="col-sm-9 col-xs-12">
                                            <div class="well clearfix" style="padding:10px 10px 0 10px; margin-bottom:0px;">
                                                ...
                                                <?php
                                                        ...
                                                        echo '<div class="col-xs-12 form-group"><label style="margin:-10px; color: #555; font-weight: normal;">Tidak Ada Fasilitas Baru</label></div>';
                                                    }
                                                ?>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group <?= $sumber_tdb_class; ?>" id="sumberTDBDiv">
                                        ...
                                        <div class="col-sm-9 col-xs-12">
                                            <select class="form-control js-example-basic-single" id="sumber_tdb" name="sumber_tdb" style="width:100%" readonly disabled>
                                                <?php
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-3 col-xs-12">
                                            <label for="sumber_tdb" class="control-label">Realisasi</label>
                                        </div>
                                        <div class="col-sm-9 col-xs-12">
                                            <label id="sumber_tdb" class="control-label" style="font-weight:normal;"><?= $pipeline->realisasi; ?></label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-3 col-xs-12">
                                ...
                                <div class="col-xs-12">
                                    <div class="form-group pull-right">
                                        <div class="col-xs-12">
                                            ...
                                            <button id="btn_comment_pipeline" class="btn w150 btn-sm btn-primary pull-right" type="button" style="margin-right:0px;">Komentar</button>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="commentPipelineForm" action="<?= base_url().'pipeline/single_comment_pipeline'; ?>" method="POST">
                        ...
                        <input type="hidden" name="created_by" value="<?= $pipeline->created_by; ?>" />
                        <input type="hidden" name="layer_status_id" value="<?= $pipeline->layer_status_id; ?>" />
                        <input type="hidden" name="status_id" value="<?= $pipeline->status_id; ?>" />
                    </form>
                </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.modal-comment-pipeline #btn_confirm_comment_pipeline').click(function(e){
            e.preventDefault();
            $.ajax({
                type: "post",
                url : $("#commentPipelineForm").attr("action"),
                data: $("#commentPipelineForm").serialize(),
                dataType : "json",
                beforeSend:function(){
        ...
        $("#btn_comment_pipeline").click(function(){
            $('.modal-comment-pipeline #comment').val("");
            $(".modal-comment-pipeline").modal("show");
        });
    });
</script>
