...
<?php
    $isRejected = $pipeline->isRejected;
    if($isRejected == 1){
        $globalReadonly = 'readonly disabled'; 
    }else{
        $globalReadonly = '';
    }
?>
<div class="right_col" role="main">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        <form class="form-horizontal form-label-left cmxform" id="pipelineForm" method="POST" action="<?= base_url("pipeline/process_edit/".$pipeline->id); ?>">
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="form-group no_display" id="cifDiv">
                                        ...
                                        <div class="col-sm-9 col-xs-12">
                                            <select class="form-control js-example-basic-single" id="cif" name="cif" style="width:100%;" <?= $globalReadonly; ?>>
                                                <?php
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="form-group" id="tdbDiv">
                                        ...
                                        <div class="col-sm-9 col-xs-12 radio">
                                            ...
                                            <label><input type="radio" id="tdb" name="tdb[]" value="1" <?= $selected_tdb1; ?> required>Tricle Down Business (TDB)</label>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="form-group pull-right">
                                        <div class="col-xs-12">
                                            <button id="btn_cancel_update_pipeline" class="btn w150 btn-sm btn-default" type="button">Kembali</button>
                                            <button id="btn_update_pipeline" class="btn w150 btn-sm btn-primary" type="button" style="margin-right:5px;">Simpan</button>
                                        </div>
                                    </div>
                                </div>
                            </div>                            
    ...
    <div class="modal fade modal-update-pipeline" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row form-group">
                        <div class="col-xs-12">
                            <p>Tuliskan perubahan yang anda lakukan:</p>
                ...
                <div class="modal-footer">
                    ...
                    <button id="btn_confirm_update_pipeline" type="button" class="btn w150 btn-primary modal-button-ok">Simpan</button>
                </div>
            </div>
        </div>
    </div>
...
$(document).ready(function() {
    ...
    $("#btn_cancel_update_pipeline").click(function(){
        window.location.href= base_url+"pipeline/draft";
    });

    $('#btn_confirm_update_pipeline').click(function(e){
        var form = $('#pipelineForm');
        var comment = $('.modal-update-pipeline #comment').val();
        ...
        $.ajax({
            ...
            dataType : "json",
            beforeSend:function(){
                $(".modal-update-pipeline").modal("hide");
                $(".loaderImage").show();
            },
    ...
    $("#btn_update_pipeline").click(function(){
        if($("#pipelineForm").valid()){
            $(".modal-update-pipeline #comment").val("");
            $(".modal-update-pipeline").modal("show");
        }
    });
...
function add_facility_fields(){
    ...
    inner +=    '           <div class="div-action pull-left">';
