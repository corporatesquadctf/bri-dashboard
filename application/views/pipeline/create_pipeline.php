    ...
    <div class="container">
                ...
                <div class="x_panel container_header">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?= base_url().'pipeline/draft'; ?>">Draft</a></li>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        <form class="form-horizontal form-label-left cmxform" id="pipelineForm" method="POST" action="<?= base_url("pipeline/process_create"); ?>">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-xs-12">
                                            <select class="form-control js-example-basic-single" id="sumber_pipeline" name="sumber_pipeline" style="width:100%;">
                                                <?php
                                    ...
                                    <div class="form-group no_display" id="cifDiv">
                                        ...
                                        <div class="col-sm-9 col-xs-12">
                                            ...
                                            <input type="hidden" id="cifId" name="cifId">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-3 col-xs-12">
                                        ...
                                        <div class="col-sm-9 col-xs-12">
                                            ...
                                            <select class="form-control js-example-basic-single" id="jenis_debitur" name="jenis_debitur" style="width:100%;">
                                                <?php
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-xs-12">
                                            <select class="form-control js-example-basic-single" id="sektor_usaha" name="sektor_usaha" style="width:100%;">
                                                <?php
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-xs-12">
                                            <select class="form-control js-example-basic-single" id="sub_sektor_ekonomi" name="sub_sektor_ekonomi" style="width:100%;">
                                                <?php
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-xs-12">
                                            <label id="status_debitur" class="control-label" style="font-weight:normal;">Rekening Baru</label>
                                        </div>
                                    </div>
                                    <div class="form-group no_display" id="div-suplesi-facility">
                                        ...
                                        <div class="col-sm-9 col-xs-12">
                                            <div class="well clearfix" style="padding:10px 10px 0 10px; margin-bottom: 0px;">
                                                <input type="hidden" name="jml-fasilitas-suplesi" id="jml-fasilitas-suplesi" value="0">
                                                ...
                                                <div id="fasilitas_fields">
                                                    ...
                                                    ?>
                                                        <div class="form-group removeclass_fasilitas<?php echo $i; ?>" style="margin-bottom:0px; font-size:12px;">
                                                                ...
                                                                <div class="form-group">
                                                                    <select id="drp_fasilitas<?php echo $i; ?>" name="drp_fasilitas<?php echo $i; ?>" class="js-example-basic-single form-control">
                                                                        <?php  foreach($facility_option as $row){ 
                                                                            $selected = '';
                                                                            if($row->FacilityId == $pipeline->arr_fasilitas[$i]['PipelineFacilityId']) $selected = 'selected="selected"';
                                                            ...
                                                            <div class="col-xs-3">
                                                                <div class="form-group">
                                                                    <input placeholder="Plafond" type="text" style="height:38px; text-align: right; font-size: 12px;" class="form-control money" id="plafond_fasilitas<?php echo $i; ?>" name="plafond_fasilitas<?php echo $i; ?>" data-a-dec="." data-a-sep="," onchange="calculate_plafond();" value="<?= $pipeline->arr_fasilitas[$i]['PipelineFacilityValue']; ?>" required/>
                                                                </div>
                                                            </div>
                                                            <div class="col-xs-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-xs-12">
                                            <textarea id="additional_desc" name="additional_desc" class="form-control" rows="5" maxlength="700"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="form-group pull-right">
                                        <div class="col-xs-12">
                                            <button id="btn_cancel_add_pipeline" class="btn w150 btn-sm btn-default" type="button">Kembali</button>
                                            <button id="btn_add_pipeline" class="btn w150 btn-sm btn-primary" type="button" style="margin-right:0px;">Simpan</button>
                                        </div>
                                    </div>
                                </div>
                            </div>

                            <div class="modal fade modal-add-pipeline" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p>Anda akan membuat pipeline baru. Lanjutkan?</p>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn w150 btn-default" data-dismiss="modal">Batal</button>
                                            <button id="btn_confirm_add_pipeline" type="button" class="btn w150 btn-primary modal-button-ok">Simpan</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
$(document).ready(function() {
    ...
    $("#btn_cancel_add_pipeline").click(function(){
        window.location.href= base_url+"pipeline/draft";
    });

    $("#btn_confirm_add_pipeline").click(function(e){
        e.preventDefault();
        $.ajax({
            type: "post",
            url : $("#pipelineForm").attr("action"),
            data: $("#pipelineForm").serialize(),
            dataType : "json",
            beforeSend:function(){
                $(".modal-add-pipeline").modal("hide");
                $(".loaderImage").show();
            },
        ...
        if(data.length > 0){
            ...
            if(isDefault == 0){
                ...
                if((data[0].FacilityDetail).length != 0){
                    ...
                    suplesiFacility +=  'Tidak Ada Fasilitas Lama';
                    suplesiFacility +=  '</div>';
                }
...
function add_facility_fields(){
    ...
    inner +=	'		<select id="drp_fasilitas'+facility+'" name="drp_fasilitas'+facility+'" class="js-example-basic-single form-control" style="font-size: 12px;">';
	inner +=                facility_opt;
	inner +=    '		</select>';
	inner +=	'	</div>';
    inner +=	'</div>';
