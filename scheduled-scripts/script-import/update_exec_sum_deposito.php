<?php
	echo "Importing exec_sum_deposito\n";
	$sql = "delete from exec_sum_deposito where year = ? and month = ?";
	$params = [$year, $month];
...
INSERT INTO exec_sum_deposito(year, month, division, saldo, avrgsaldo)
SELECT 
    YEAR(POSISI) year, 
    MONTH(POSISI) month,
	DIV_ID division,
...
SQL;
	...
	echo "Imported exec_sum_deposito\n";
?>