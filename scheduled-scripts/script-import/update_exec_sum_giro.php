<?php
	echo "Importing exec_sum_giro\n";
	$sql = "delete from exec_sum_giro where year = ? and month = ?";
	$params = [$year, $month];
...
INSERT INTO exec_sum_giro(year, month, division, saldo, avrgsaldo)
SELECT 
    YEAR(POSISI) year, 
    MONTH(POSISI) month,
	DIV_ID division,
